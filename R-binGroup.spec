...
Version  : 2.2.3
Release  : 43
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/binGroup_2.2-3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/binGroup_2.2-3.tar.gz
...
%setup -q -n binGroup
pushd ..
cp -a binGroup buildavx2
popd
pushd ..
cp -a binGroup buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747337047
